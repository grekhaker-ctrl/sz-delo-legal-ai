    ...
    if prompt:
        ...
        with st.spinner("🤖 Анализирую вопрос..."):
            try:
                ...
                # Улучшенный промпт для чата - развёрнутый но чёткий без заголовков
                enhanced_prompt = f"""
...
[Развёрнутый анализ - 150-200 слов, все важные аспекты]
...
Правовое основание: Статья 196 ГК РФ устанавливает общий срок исковой давности в 3 года. Статья 200 ГК РФ определяет начало течения срока.
...
Сроки: Общий срок 3 года. Начало - день сдачи работы или обнаружения недостатков. Последствия пропуска - отказ в иске.

Что делать: 1. Фиксируйте дату сдачи работы актом. 2. Проводите осмотр после сдачи. 3. При недостатках пишите претензию. 4. Подавайте иск в течение 3 лет. 5. Храните документы 4 года.
...
[Риски - перечисли пункты договора с указанием конкретных статей ГК РФ и уровнем риска]

[Что исправить - конкретные действия по порядку]

[Сроки и последствия - если есть]
...
[Риски со статьями ГК РФ]

[Что делать - 3-5 конкретных шагов]
