    ...
    if prompt:
        ...
        with st.spinner("🤖 Анализирую вопрос..."):
            try:
                ...
                # Улучшенный промпт для чата - КРАТКО И КОНКРЕТНО
                enhanced_prompt = f"""
...
ТРЕБОВАНИЯ:
1. ОТВЕТ КРАТКИЙ И КОНКРЕТНЫЙ - МАКСИМУМ 400 СЛОВ
2. БЕЗ ВОДЫ И ОБЩИХ ФРАЗ
...
ТРЕБОВАНИЯ:
1. КРАТКО И КОНКРЕТНО - МАКСИМУМ 400 СЛОВ
2. БЕЗ ВОДЫ
...
ФОРМАТ:
1. Тип договора [1 предложение]
2. Вывод (✅/⚠️/❌)
3. Риски [ст. XXX ГК РФ]
4. Что делать [1, 2, 3]
5. Источник [КонсультантПлюс 2025]
"""
