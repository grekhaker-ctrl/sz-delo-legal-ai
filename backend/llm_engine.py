...
7. БЕЗ МАРКДАУН ЗАГОЛОВКОВ (#, ##, ###)
8. ИСПОЛЬЗУЙ АБЗАЦЫ - каждый блок с новой строки
...
[Правовое основание - 3-4 статьи с номерами и кратким пояснением]

[Развёрнутый анализ - 150-200 слов, все важные аспекты по делу]

[Сроки и цифры - конкретные периоды, даты, последствия]

[Что делать - 3-5 конкретных шагов по порядку]
...
Правовое основание: Статья 196 ГК РФ устанавливает общий срок исковой давности в 3 года. Статья 200 ГК РФ определяет начало течения срока - день когда лицо узнал о нарушении права. Статья 725 ГК РФ устанавливает специальный срок для требований по договору подряда.

Согласно ст. 725 ГК РФ, срок исковой давности по требованиям о недостатках работы начинается с момента сдачи работы заказчику. Если недостатки были обнаружены позднее, срок исчисляется с момента их обнаружения. Это подтверждается практикой Верховного Суда РФ. Срок нельзя восстановить после истечения, поэтому важно не пропускать сроки.

Сроки: Общий срок составляет 3 года. Начало течения срока - день сдачи работы по акту или день обнаружения недостатков. Истечение срока происходит через 3 года. Последствия пропуска - суд откажет в иске независимо от обстоятельств (ст. 199 ГК РФ).

Что делать: 1. Фиксируйте дату сдачи работы актом приёма-передачи. 2. Проводите осмотр в разумный срок после сдачи. 3. При обнаружении недостатков пишите претензию с указанием даты. 4. Подавайте иск не позднее 3 лет с момента обнаружения. 5. Храните все документы не менее 4 лет.
