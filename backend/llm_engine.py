...
- КонсультантПлюс: https://www.consultant.ru
- Гарант: https://www.garant.ru
- ГК РФ: https://www.consultant.ru/document/cons_doc_LAW_28165/
- НК РФ: https://www.consultant.ru/document/cons_doc_LAW_28166/
...
- Статья 200 ГК РФ: начало течения с момента нарушения
- Статья 725 ГК РФ: специальный срок по договору подряда

Согласно ст. 725 ГК РФ, срок исковой давности по требованиям о недостатках работы начинается с момента сдачи работы заказчику. Если недостатки обнаружены позднее, срок исчисляется с момента их обнаружения. Это подтверждается практикой Верховного Суда РФ. Срок нельзя восстановить после истечения, поэтому важно не пропускать сроки.
